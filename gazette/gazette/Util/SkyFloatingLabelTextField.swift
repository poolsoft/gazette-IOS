...
@IBDesignable
open class SkyFloatingLabelTextField: UITextField, Validatable {
...
//		}
	...
	var customValidator: (() -> (Bool, String))?
	var required = false
	func isValid() -> (Bool, String) {
		if required {
			if unwrappedCleanText.isEmpty {
				return (false, "FieldIsEmpty".localized)
			}
		}
